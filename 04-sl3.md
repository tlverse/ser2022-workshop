...
runtime_sl_fit
   user  system elapsed 
260.316   1.527 261.590 
```

It took 261.6 seconds 
(4.4 minutes) to fit the SL. 
...
<div class="figure" style="text-align: center">
<img src="04-sl3_files/figure-html/varimp-plot-1.png" alt="sl3 variable importance for predicting weight-for-height z-score with WASH Benefits example dataset" width="80%" />
